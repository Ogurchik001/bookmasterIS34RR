...
namespace bookmasterIS34RR.Models;

public partial class BookmasterEgorRis34Context : DbContext
{
    public BookmasterEgorRis34Context()
    {
    }

    public BookmasterEgorRis34Context(DbContextOptions<BookmasterEgorRis34Context> options)
        : base(options)
    {
    }
